...
exports.triangle=function(side1,side2,side3){
    if(side1 <=0 || side2 <=0|| side3 <= 0 || typeof side1 === 'string' ||typeof side2 === 'string'|| typeof side3 === 'string' ){
        return "Invalid"
    }else {
        ...
        else if ((shortSide == middleSide) && (middleSide == longSide) && (shortSide==longSide))
            return "Equilateral";
        else if ((shortSide == middleSide) || (middleSide == longSide) || (shortSide==longSide))
            return "Isosceles";
        else
